...
public class FeedImageView extends ImageView {
     ...
     * url -  it's URL that should be loaded into this ImageView.
     * imageLoader -  it's ImageLoader that will be used to make the request.
     */
     ...
     * isInLayoutPass - true if this was invoked from a layout pass, false otherwise.
     */
        ...
        ImageContainer newContainer = mImageLoader.get(mUrl,
                new ImageListener() {
                    ...
                    public void onResponse(final ImageContainer response,
                         ...
                         * trigger a requestLayout inside of a layout. Instead, defer setting the image
